...
import { isCategoriesValid, isNameValid, isExpirationValid } from './validators';
    ...
    return (
        <Form onSubmit={onSubmit}>
            ...
            <FormGroup>
                ...
                <Input
                    invalid={!isExpirationValid(expirationDate)}
                    type="date"
                    name="expirationDate"
                    id="expirationDate"
                    value={expirationDate}
                    onChange={({ target }) => isExpirationValid(target.value) && setExpirationDate(target.value)}
                />
            ...
            <FormGroup check>
                <Label check>
                    <Input disabled={true} type="checkbox" checked={featured}
